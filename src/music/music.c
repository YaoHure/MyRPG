...
t_music **init_val_music(void)
{
    ...
    if (!music)
        return (NULL);
    music[0] = init_music("res/music/peace.ogg");
    music[1] = init_sound("res/music/click.ogg");
    music[2] = init_sound("res/music/death.ogg");
    music[3] = init_sound("res/music/sword.ogg");
    music[4] = init_sound("res/music/hurt.ogg");
    music[5] = NULL;
    return (music);
}
